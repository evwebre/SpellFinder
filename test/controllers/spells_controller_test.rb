...
class SpellsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spell" do
    assert_difference('Spell.count') do
      post spells_url, params: { spell: { casting_time: @spell.casting_time, classes: @spell.classes, description: @spell.description, higher_level: @spell.higher_level, range: @spell.range } }
    end
  ...
  test "should update spell" do
    patch spell_url(@spell), params: { spell: { casting_time: @spell.casting_time, classes: @spell.classes, description: @spell.description, higher_level: @spell.higher_level, range: @spell.range } }
